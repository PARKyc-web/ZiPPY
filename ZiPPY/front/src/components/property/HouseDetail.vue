<template>
  <div class="map_wrap">
    ...
    <div class="text-center">
      <v-btn class="mx-2" fab dark color="blue darken-2 ">
        <v-icon dark>
          mdi-subway-variant
        </v-icon>
      </v-btn>
    ...
    <div class="text-center">지하철 편의점 카페 은행 관공서 공공기관</div>
    <div class="text-center">
    ...
    <div class="text-center">어린이집/유치원 학교</div>
