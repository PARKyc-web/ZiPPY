<template>
  ...
  <div id="detail-container">
    ...
    <div id="detail-info">
      ...
      <h6 class="pb-5">
        <v-icon color="#B3E3C3" class="pr-2">mdi-truck</v-icon>배송비<span>
          3,000</span
        >원
      </h6>
      <!-- 옵션 -->
      ...
      <div id="detail-button">
        ...
        <v-btn width="160" depressed color="#B3E3C3"> 바로구매 </v-btn>
      </div>
      <!-- 버튼 끝 -->
    </div>
    <!-- 상품 상세정보 -->
    ...
    <v-card class="mt-5">
      ...
      <v-tabs-items v-model="tabs">
        ...
        <v-tab-item>
          <v-card flat>
            <v-card-text>
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
            ...
            <div id="review-box" class="px-3">
              ...
              <div id="user-info">
                ...
                <div id="report-review">
                  <p>신고<v-icon>mdi-alarm-light</v-icon></p>
                </div>
              </div>
              <!-- 사용자 정보 끝-->
              <!-- 별점 -->
              <div style="display: flex">
                <p>
                  <v-icon style="font-size: 15px; color: #b3e3c3" class="pb-1"
                    >mdi-star</v-icon
                  >
                  5.0
                </p>
              ...
              <p>옵션:white(L size)</p>
              <p>
                코딩이 잘 되는지 모르겠음 사기당함 코딩이 잘 되는지 모르겠음
                사기당함 코딩이 잘 되는지 모르겠음 사기당함 코딩이 잘 되는지
                모르겠음 사기당함 코딩이 잘 되는지 모르겠음 사기당함 코딩이 잘
                되는지 모르겠음 사기당함
              </p>
              <hr />
            </div>
              ...
              >
                        ...
                        <v-card>
                          ...
                          <v-card-text>
                            ...
                            <small>
                              <v-row>
                                <v-col cols="12">
                                  - 문의내용에 대한 답변은 ‘마이페이지 > 나의
                                  쇼핑 > 나의 문의내역’ 또는 ‘상품
                                  상세페이지’에서 확인 가능합니다.
                                  <br />
                                  - 배송,결제,교환/반품 문의는 고객센터로 문의
                                  바랍니다.
                                  <br />
                                  - 상품과 관련 없거나 부적합한 내용을
                                  기재하시는 경우, 사전 고지 없이 삭제 또는
                                  차단될 수 있습니다.
                                </v-col>
                              </v-row>
                            </small>
                ...
                <div id="seller-content">
                  <p style="font-size: smaller">
                    - 먼저 문의하신 다른 고객님들의 질문을 참조하시면, 유용한
                    정보를 빠르게 확인하실 수 있습니다.
                  </p>
                  <p style="font-size: smaller">
                    - 휴일 및 공휴일, 영업시간 종료 이후에 남겨주신 문의 사항은,
                    평일 영업시간에 답변을 해드리고 있습니다.
                  </p>
                </div>
              </div>
              <!-- 상품리뷰 끝 -->
