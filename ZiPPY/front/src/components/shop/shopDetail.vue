<template>
  ...
  <div id="detail-container">
    ...
    <div id="detail-info">
      ...
      <h4 style="display:block; padding-bottom: 30px;">코딩 잘 되는 책상</h4>
      <h1 style="display:inline-block">11,111</h1>
      <h5 style="display:inline-block">원</h5>
      <h6 class="pb-5">
        <v-icon color="#B3E3C3" class="pr-2">mdi-truck</v-icon>배송비<span> 3,000</span>원
      </h6>
      <!-- 옵션 -->
      <div class="mb-5">
        <v-overflow-btn id="drop" class="my-2" :items="colors" label="색상을 선택해주세요" dense></v-overflow-btn>
      </div>
      <div class="mb-5">
        <v-overflow-btn id="drop" class="my-2" :items="sizes" label="사이즈를 선택해주세요" dense></v-overflow-btn>
      </div>
      <!-- 옵션 끝 -->
      <!-- 총 가격 -->
      <div id="total-price">
      ...
      <div id="detail-button">
        <v-btn width="160" class="mr-2" outlined color="#B3E3C3">
          장바구니
        </v-btn>
    ...
    <!-- 탭 -->
    <v-card class=mt-5>
      <v-toolbar height="10" class="pt-0">
        <template v-slot:extension>
          <v-tabs v-model="tabs" fixed-tabs background-color="#F7F7F7" light color="#B3E3C3" slider-color="#B3E3C3">
            <v-tab>
              상품정보
            </v-tab>
            <v-tab>
      ...
      <v-tabs-items v-model="tabs">
        ...
        <v-tab-item>
          <v-card flat>
            <v-card-text>
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
              상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다. 상품정보입니다.
            </v-card-text>
                        ...
                        <v-card>
                          ...
                          <v-card-text>
                            <v-container>
                              <v-row>
                                <v-col cols="11">
                                  <v-select :items="['상품문의', '배송문의', '기타문의']" label="문의 유형을 선택해주세요" required></v-select>
                                </v-col>
                                <v-col cols="12">
                                  문의내용
