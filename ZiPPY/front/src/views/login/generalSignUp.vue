                  ...
                  <div id="first-form">
                    <div class="form-floating mb-3">
                      <input type="email" name="email" class="form-control" id="inputEmail"
                        placeholder="name@example.com" v-model="user_info.email" />
                      <button class="btn btn-outline-success" id="email_code" type="button" @click="email_validation()">
                        인증번호 전송
                      </button>
                    ...
                    <div class="form-floating mb-3">
                      ...
                      <button type="button" id="email-confirm-btn" class="btn btn-outline-success" disabled
                    ...
                    <div class="form-floating mb-3">
                      <input type="password" class="form-control" v-model="user_info.password" id="password"
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="phone" placeholder="전화번호 입력"
                        v-model="user_info.phoneNumber" name="phoneNumber" />
                    ...
                    <div class="form-floating mb-3">
                      <input name="userName" type="text" class="form-control" v-model="user_info.userName"
                        id="user_name" placeholder="park" />
                      <label for="user_name">사용자 이름</label>
                    </div>

                    <div class="form-floating mb-3">
                      <input name="nickName" type="text" class="form-control" v-model="user_info.nickName"
                        id="user_nick" placeholder="nick" />
                      <label for="user_nick">닉네임</label>
                    </div>

                    <div class="form-floating mb-3">
                      <input name="userBirth" type="date" v-model="user_info.userBirth" class="form-control"
                        id="user_birth" placeholder="11223344" />
                    ...
                    <br />
                    <div class="form-floating mb-3">
                      <input name="userAddress" type="text" class="form-control" id="addressInput" placeholder="주소검색"
                        v-model="user_info.userAddress" readOnly @click="find_address()" />
                      <label for="addressInput">(우편번호) 주소</label>
                    </div>

                    <div class="form-floating mb-3">
                      <input name="addressDetail" type="text" class="form-control" v-model="user_info.addressDetail"
