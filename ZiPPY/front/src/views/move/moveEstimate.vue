                ...
                <v-row justify="center">
                  ...
                  <v-dialog v-model="dialog" persistent max-width="600px">
                    ...
                    <form id="estimateForm" name="estimateForm">
                          ...
                          <v-card-text>
                            <v-container>
                              <v-row>
                                ...
                                <v-col cols="12">
                                  <v-text-field label="업체명*" hint="고객에게 보여주는 업체의 이름입니다." v-model="selectData.compName">
                                  </v-text-field>
                                </v-col>
                                <v-col cols="12">
                                  <v-text-field label="업체아이디*" hint="고객에게 보여주는 업체의 이메일입니다." v-model="selectData.email">
                                  </v-text-field>
                                </v-col>
                                <v-col cols="12">
                                  <v-text-field label="1차 견적타입*" required readonly hint="고객이 기본적으로 요청한 견적 타입입니다."
                                    v-model="selectData.estimateType"></v-text-field>
                                </v-col>
                                <v-col cols="12">
                                  <v-text-field label="1차 견적가격*" type="number" id="firstPrice"
                                    hint="고객에게 처음 제시하는 견적가격입니다. 견적제시는 2차까지만 가능합니다. 신중하게 결정해주세요.(추후 수정불가)" required
                                    v-model="selectData.firstEstimatePrice">
                                  </v-text-field>
                                </v-col>
                                <v-col>
                      ...
                      <input type="hidden" name="firstEstimatePrice" id="firstPrice"
                        v-model="selectData.firstEstimatePrice">
