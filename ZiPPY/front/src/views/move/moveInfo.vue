  ...
  <div class="wrap">
    <h2>이사 견적을 위한 기본 정보를 입력해주세요.</h2>
		...
		<!-- 지도 -->
			...
			우편번호 : <input v-model="postcode" class="type-2" type="text" name="zip1" style="width: 80px; height: 26px;" />
				<button class="custom-btn btn-4" type="button" @click="execDaumPostcode()">검색</button>
			<br> 
			주소 : <input v-model="address" id="address" class="type-2" type="text" name="addr1" style="width: 300px; height: 30px;" readonly /><br> 
			상세 : <input v-model="extraAddress" id="detailAddress" class="type-2" type="text" name="addr2" style="width: 300px; height: 30px;" /><br>
      참고항목 : <input type="text" id="extraAddress" class="type-2" placeholder="참고항목">
      ...
      우편번호 : <input v-model="postcode2" class="type-2" type="text" name="zip2" style="width: 80px; height: 26px;" />
				<button class="custom-btn btn-4" type="button" @click="execDaumPostcode2()">검색</button>
			<br> 
			주소 : <input v-model="address2" id="address2" class="type-2" type="text" name="addr3" style="width: 300px; height: 30px;" readonly /><br> 
			상세 : <input v-model="extraAddress2" id="detailAddress2" class="type-2" type="text" name="addr4" style="width: 300px; height: 30px;" /><br>
      참고항목 : <input type="text" id="extraAddress2" class="type-2" placeholder="참고항목">
