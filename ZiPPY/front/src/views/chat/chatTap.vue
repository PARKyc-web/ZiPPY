<template>
    <div style="border-top: 1px solid #D6D6D6;">
        <div id="con">
            ...
            <div class="container">
                <b-list-group>
                    <b-list-group-item class="flex-column align-items-start" style="border:0; padding:17px"
                        v-for="(item, i) in chatRooms" @click="enterChatRoom(item)">
                        <!-- chat con -->
                        <div id="chat-con">
                            <!--  style="display:flex" -->
                            ...
                            <div id="name" style="width:85%; height:20px;">
                                <div style="float:left">
                                    <div class="pl-2" style="width:300px"
                                        v-if="$store.state.loginInfo.email == item.user1">
                                        {{item.user2Name}}
                                    </div>
